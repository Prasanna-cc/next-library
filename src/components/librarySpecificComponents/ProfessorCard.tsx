...
const ProfessorCard: React.FC<ProfessorCardProps> = ({
  ...
  return (
    <Card className="w-full relative">
      ...
      <CardContent className="p-4 w-full flex flex-col gap-2 md:gap-4">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p className="text-sm text-slate-500">
                          This professor has yet to set up their Calendly
                          account,
        ...
        {isMobileView && (
          <div className="w-full h-full flex flex-col justify-end items-end">
            {details.eventLink ? (
              <Link
                className=" h-full"
                href={`/dashboard/sessions?eventLink=${details.eventLink}`}
              >
              ...
              <Button
                variant={"outline"}
                className="h-full text-xs text-slate-500"
                disabled
              >
                no sessions yet...
              </Button>
